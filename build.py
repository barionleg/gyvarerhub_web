...
js_files = [
    ...
    'src/inc/utils.js',
    'src/inc/devices.js',
    'src/inc/connection.js',
    'src/inc/fs.js',
    'src/inc/parser.js',
    'src/inc/ui.js',
    'src/inc/test.js',
    'src/inc/sort-paths.min.js',
    'src/inc/mqtt.min.js',
    'src/inc/pickr.min.js',
    'src/inc/joy.js',
]

css_files = [
    'src/inc/style.css',
    'src/inc/nano.min.css',
]
...
shutil.copyfile('src/inc/fa-solid-900.woff2', 'host/fa-solid-900.woff2')
shutil.copyfile('src/inc/PTSans-Narrow.woff2', 'host/PTSans-Narrow.woff2')
...
with open("src/inc/fa-solid-900.woff2", "rb") as f:
    fa_b64 += (base64.b64encode(f.read())).decode('ascii')

pt_b64 = 'data:font/woff2;charset=utf-8;base64,'
with open("src/inc/PTSans-Narrow.woff2", "rb") as f:
...
with open("src/inc/fa-solid-900.min.woff2", "rb") as f:
