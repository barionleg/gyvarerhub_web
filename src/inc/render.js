    ...
    <div id="config" class="cfg_in">
      ...
      <div class="cfg_col">
        <div class="cfg_row cfg_head cfg_clickable" onclick="use_local.click()">
          <label class="cfg_label cfg_clickable" id="local_label"><span class="icon cfg_icon"></span>Local</label>
        ...
        <div id="local_block" style="display:none">
          ...
          <div id="http_settings">
            <div class="cfg_row">
              <label class="cfg_label">Local IP</label>
            ...
            <div class="cfg_row">
              ...
              <div class="cfg_inp_row cfg_inp_row_fix">
                <input class="cfg_inp" type="text" value="192.168.1.1" id="local_add_ip">
                <div class="cfg_btn_block">
                  <button class="icon cfg_btn" onclick="add_ip_h(local_add_ip.value)"></button>
                </div>
              </div>
            </div>
      ...
      <div class="cfg_col" id="mq_col">
        ...
        <div id="mq_block" style="display:none">
          ...
          <div class="cfg_row">
            ...
            <div class="cfg_inp_row cfg_inp_row_fix"><input class="cfg_inp" type="text" id="mq_host" onchange="update_cfg(this);hub.mqtt.stop()"></div>
          </div>

          <div class="cfg_row">
            <label class="cfg_label">Port (WS TLS)</label>
            <div class="cfg_inp_row cfg_inp_row_fix"><input class="cfg_inp" type="number" id="mq_port" onchange="update_cfg(this);hub.mqtt.stop()"></div>
          </div>

          <div class="cfg_row">
            <label class="cfg_label">Login</label>
            <div class="cfg_inp_row cfg_inp_row_fix"><input class="cfg_inp" type="text" id="mq_login" onchange="update_cfg(this);hub.mqtt.stop()"></div>
          </div>
